...
import com.indmind.mynotesapp.adapter.NoteAdapter;
import com.indmind.mynotesapp.db.NoteHelper;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, LoadNotesCallback {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (data != null) {
            if (requestCode == NoteAddUpdateActivity.REQUEST_ADD && resultCode == NoteAddUpdateActivity.RESULT_ADD) {
