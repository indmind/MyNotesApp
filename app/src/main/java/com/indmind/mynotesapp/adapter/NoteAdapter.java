package com.indmind.mynotesapp.adapter;
...
import com.indmind.mynotesapp.CustomOnClickListener;
import com.indmind.mynotesapp.NoteAddUpdateActivity;
import com.indmind.mynotesapp.R;
...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.NoteViewHolder> {
    ...
    public void onBindViewHolder(@NonNull NoteViewHolder holder, int i) {
        ...
        holder.cvNote.setOnClickListener(new CustomOnClickListener(i, new CustomOnClickListener.OnItemClickCallback() {
            @Override
